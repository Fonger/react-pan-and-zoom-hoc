    ...
    return _a = /** @class */ (function (_super) {
            ...
            function PanAndZoomHOC() {
                ...
                _this.handleWheel = function (event) {
                    var _a = _this.props, onPanAndZoom = _a.onPanAndZoom, renderOnChange = _a.renderOnChange, disableScrollZoom = _a.disableScrollZoom, onZoom = _a.onZoom;
            ...
            PanAndZoomHOC.prototype.render = function () {
                var _a = this.props, children = _a.children, scaleFactor = _a.scaleFactor, tempX = _a.x, tempY = _a.y, tempScale = _a.scale, minScale = _a.minScale, maxScale = _a.maxScale, onPanStart = _a.onPanStart, onPanMove = _a.onPanMove, onPanEnd = _a.onPanEnd, onZoom = _a.onZoom, onPanAndZoom = _a.onPanAndZoom, renderOnChange = _a.renderOnChange, passOnProps = _a.passOnProps, ignorePanOutside = _a.ignorePanOutside, disableScrollZoom = _a.disableScrollZoom, other = __rest(_a, ["children", "scaleFactor", "x", "y", "scale", "minScale", "maxScale", "onPanStart", "onPanMove", "onPanEnd", "onZoom", "onPanAndZoom", "renderOnChange", "passOnProps", "ignorePanOutside", "disableScrollZoom"]);
                var x = this.props.x;
                var y = this.props.y;
                var scale = this.props.scale;
                if (x !== undefined && y !== undefined && scale !== undefined) {
                    var passedProps = passOnProps ? { x: x + this.dx, y: y + this.dy, scale: scale + this.ds } : {};
                    return (React.createElement(WrappedComponent, __assign({}, passedProps, other, { ref: this.componentRef, onMouseDown: this.handleMouseDown, onTouchStart: this.handleMouseDown }), children));
                }
                else {
                    return null;
                }
